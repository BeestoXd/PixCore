package com.pixra.pixcore.integration.strikepractice;
...
public class StrikePracticeHook {
    ...
    private Method mGetStrikePracticePlugin;
    private Method mApiGetArenaByName;
    private Method mApiGetArenas;
    private Method mArenaGetCenter;
    private Method mArenaGetMin;
    private Method mArenaGetMax;
    private Method mArenaGetOriginalName;
    ...
    public void hook() {
        ...
        try {
            ...
            try { this.mGetStrikePracticePlugin = apiClass.getMethod("getStrikePractice"); } catch (Exception ignored) {}
            try { this.mApiGetArenaByName = apiClass.getMethod("getArena", String.class); } catch (Exception ignored) {}
            try { this.mApiGetArenas      = apiClass.getMethod("getArenas"); } catch (Exception ignored) {}
            ...
            try {
                ...
                this.mArenaGetCenter = arenaClass.getMethod("getCenter");
                this.mArenaGetMin    = arenaClass.getMethod("getCorner1");
                this.mArenaGetMax    = arenaClass.getMethod("getCorner2");
                try { this.mArenaGetOriginalName = arenaClass.getMethod("getOriginalName"); } catch (Exception ignored) {}
    ...
    public Method getMGetStrikePracticePlugin() { return mGetStrikePracticePlugin; }
    public Method getMApiGetArenaByName()    { return mApiGetArenaByName; }
    public Method getMApiGetArenas()         { return mApiGetArenas; }
    public Method getMArenaGetCenter()       { return mArenaGetCenter; }
    public Method getMArenaGetMin()          { return mArenaGetMin; }
    public Method getMArenaGetMax()          { return mArenaGetMax; }
    public Method getMArenaGetOriginalName() { return mArenaGetOriginalName; }
